...
- If comparing build/lint output across worktrees (e.g. base vs branch), copy generated dirs (e.g. `convex/_generated`) into BOTH sides first — regenerating can mutate shared backends, and asymmetric copies produce spurious deltas.
